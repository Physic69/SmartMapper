...
class EnhancedVelocityPositionEstimator(
    ...
    private val gravityFilterAlpha = 0.8f // A low-pass filter coefficient.
    ...
    fun update(
        ...
        // --- START OF GRAVITY FIX ---
        // ALWAYS update the gravity estimate. The low-pass filter ensures it
        // ignores quick movements and only tracks the constant pull of gravity.
        for (i in 0..2) {
